...
const LandingPage = () => {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col md:flex-row px-4 sm:px-10">
      {/* Profile Section */}
      <div className="bg-[#28292a] text-white w-full md:w-[23%] lg:w-[20%] p-6 rounded-lg shadow-lg md:fixed md:left-[15%] md:top-30 md:h-[70vh] flex flex-col items-center">
        <img
      ...
      <div className="md:ml-[40%] lg:ml-[38%] w-full md:w-[55%] mt-10 py-18 overflow-y-auto text-white mr-[20%]">
      ...
      <div className="relative overflow-hidden w-full mt-6">
        ...
        <div className="col-span-1 sm:col-span-1 bg-black text-white p-6 rounded-lg shadow-lg">
