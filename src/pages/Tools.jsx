...
const Tools = () => {
  return (
    <div className="bg-black min-h-screen flex flex-col md:flex-row px-4 sm:px-10">
      ...
      <div className="md:ml-[40%] mt-15 lg:ml-[38%] w-full md:w-[55%] py-10 overflow-y-auto order-first sm:order-first">
        <h1 className="text-6xl sm:text-6xl text-white font-bold text-left mt-10">
      ...
      <div className="bg-[#28292a] text-white w-full md:w-[25%] lg:w-[20%] p-6 rounded-lg shadow-lg md:fixed md:left-[15%] md:top-30 md:h-[80vh] flex flex-col items-center order-last sm:order-last">
        <img
          src="https://framerusercontent.com/images/H3gQyzjQNWcYB4RqhjHgnNIOI.png?scale-down-to=600"
          alt="Profile"
          className="rounded-lg w-72 h-72 mx-auto"
